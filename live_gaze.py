...
class EyeTrackerManager:
    ...
    def gaze_data_callback(self, gaze_data):
        ...
        lx = gaze_data.left_eye.gaze_point.position_on_display_area[0] * self.winsize[0]
        ly = self.winsize[1] - gaze_data.left_eye.gaze_point.position_on_display_area[1] * self.winsize[1]
        lp = gaze_data.left_eye.pupil.diameter
        lv = gaze_data.left_eye.gaze_point.validity
        rx = gaze_data.right_eye.gaze_point.position_on_display_area[0] * self.winsize[0]
        ry = self.winsize[1] - gaze_data.right_eye.gaze_point.position_on_display_area[1] * self.winsize[1]
...
with EyeTrackerManager() as et_manager:
    win = visual.Window(size = et_manager.winsize, fullscr=True, units='pix', pos = (0, 30))
